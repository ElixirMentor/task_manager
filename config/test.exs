import Config
config :task_manager, token_signing_secret: "fmI8c0Yv6pY9q0UYG7MquJIBSEMD+hHv"
...
config :task_manager, TaskManagerWeb.Endpoint,
  ...
  secret_key_base: "0UtJX0lMa2TUc31F0DQJ30rw+ZPkSq4fSxJqk5vNjatNRznK3+S0lYYcLs/mELur",
  server: false
